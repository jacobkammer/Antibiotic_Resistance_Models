...
MODEL_PATH = os.path.join(THIS_DIR, "model_transfer_rate_exploration.py")
...
for species, growth_rate_h, immune_death_rate_h in kinetic_specs:
    ...
    kinetic_rows.append({
        'Species': species,
        'Growth_rate_per_h': growth_rate_h,
        'Immune_death_rate_per_h': immune_death_rate_h,
        'Net_growth_rate_per_h': net_rate_h,
...
kinetic_df.to_csv('bacterial_growth_death_kinetics.csv', index=False)
print('Bacterial growth/death kinetics:')
print(kinetic_df)
print('Saved: bacterial_growth_death_kinetics.csv')
print()
...
# -------------------------------------------------------------------------
# Blood compartments start at zero; the blood compartment is seeded entirely
# from bone via f_r_b throughout the simulation. This produces the correct
